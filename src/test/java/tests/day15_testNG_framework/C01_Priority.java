...
public class C01_Priority {
    ...
    public void carpmaTesti(){
        //sayilarin carpiminin 100 den büyük oldugunu test edin
    ...
    public void cikarmaTesti(){
        // a ile b nin farkinin mutlakdegerinin 100 den kucuk oldugunu test edin
        Assert.assertTrue((a-b)>-100 && (a-b)<100);
    }
}
/*
TestNG hicbir mudahale olmazsa testleri isim sirasina gore calistirir
